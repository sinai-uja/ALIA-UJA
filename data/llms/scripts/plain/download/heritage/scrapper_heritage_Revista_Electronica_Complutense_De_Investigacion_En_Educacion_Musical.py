"""Recolector de datos OAI-PMH para la RECIEM (Revista Electrónica Complutense de Investigación en Educación Musical).

Este módulo recolecta artículos de la RECIEM (UCM) mediante OAI-PMH.

Example:
    python scrapper_heritage_Revista_Electronica_Complutense_De_Investigacion_En_Educacion_Musical.py

Note:
    URL: https://revistas.ucm.es/index.php/RECI/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la RECIEM.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "RECIEM"],
        ...         "https://revistas.ucm.es/index.php/RECI/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "RECIEM"],
        urls="https://revistas.ucm.es/index.php/RECI/oai"
    )
    scraper.execute()