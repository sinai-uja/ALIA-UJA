"""Recolector de datos OAI-PMH para UcoArte (Revista de Historia del Arte).

Este módulo recolecta artículos de UcoArte (Universidad de Córdoba) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDeCordoba_UcoArte.py
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para UcoArte.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_UcoArte"],
        ...         "https://journals.uco.es/ucoarte/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_UcoArte"],
        urls="https://journals.uco.es/ucoarte/oai"
    )
    scraper.execute()
