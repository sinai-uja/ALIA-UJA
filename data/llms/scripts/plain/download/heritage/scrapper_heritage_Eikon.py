"""Recolector de datos OAI-PMH para la Revista Eikon.

Este módulo implementa un método que recolecta información sobre artículos
de la Revista Eikon / Imago de la Universidad Complutense de Madrid mediante
el protocolo OAI-PMH utilizando el cliente Sickle.

La Revista Eikon contiene:
    - Artículos de iconografía e iconología aplicadas a la historia del arte
    - Estudios sobre la imagen en sus contextos histórico-culturales
    - Publicaciones de acceso abierto de la UCM

Example:
    Ejecución básica::

        python scrapper_heritage_Eikon.py

Note:
    URL: https://revistas.ucm.es/index.php/EIKO/oai
"""
...
class Scraper:
    ...
    Example:
        ...
        ...     folders=["ALIA", "Revista_Eikon"],
        ...     urls="https://revistas.ucm.es/index.php/EIKO/oai"
        ... )
        >>> scraper.execute()
    """
