"""Recolector de datos OAI-PMH para la Revista Palaeohispanica.

Este módulo recolecta artículos de la Revista Palaeohispanica (Institución
Fernando el Católico) mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Paleohispanica.py

Note:
    URL: https://ifc-ojs.es/index.php/palaeohispanica/oai
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Paleohispanica"],
        ...         "https://ifc-ojs.es/index.php/palaeohispanica/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Paleohispanica"],
        urls="https://ifc-ojs.es/index.php/palaeohispanica/oai"
    )
    scraper.execute()