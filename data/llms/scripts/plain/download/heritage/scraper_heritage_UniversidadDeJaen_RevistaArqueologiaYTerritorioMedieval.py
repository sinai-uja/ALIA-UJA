"""Recolector de datos OAI-PMH para Arqueología y Territorio Medieval.

Este módulo recolecta artículos de Arqueología y Territorio Medieval (Universidad de Jaén) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDeJaen_RevistaArqueologiaYTerritorioMedieval.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Patrimonio_Arqueologia_Y_Territorio_Medieval"],
        ...         "https://revistaselectronicas.ujaen.es/index.php/ATM/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Patrimonio_Arqueologia_Y_Territorio_Medieval"],
        urls="https://revistaselectronicas.ujaen.es/index.php/ATM/oai"
    )
    scraper.execute()
