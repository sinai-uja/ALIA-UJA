"""Recolector de datos web para la Revista El Pájaro de Benín.

Este módulo recolecta artículos de la Revista El Pájaro de Benín.
Extrae los PDF de investigación sobre cultura.

Example:
    python scraper_heritage_Revista_El_Pajaro_De_Benin.py
"""
...
class Scraper:
    """Recolector de datos OAI-PMH o archivos web para El Pájaro de Benín.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_El_Pajaro_De_Benin"],
        ...         "https://ejemplo.com/oai").execute()
    """
                ...
                if enlace:
                    ...
                    if href:
                        ...
                        if is_doc:
                            ...
                            self.logger.warning(f"Archivo en página no es PDF: {pdf_url}")
                            return ""
                    else:
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_El_Pajaro_De_Benin"],
        urls="https://revistascientificas.us.es/index.php/pajaro_benin/oai"
    )
    scraper.execute()