"""Recolector de datos OAI-PMH para la Revista Historia Social y de la Educación.

Este módulo implementa un método que recolecta información sobre artículos
de la Revista Historia Social y de la Educación (Hipatia Press) mediante el
protocolo OAI-PMH utilizando el cliente Sickle.

La Revista Historia Social y de la Educación contiene:
    - Artículos de historia social, laboral y de la educación
    - Investigaciones interdisciplinares de historia contemporánea
    - Publicaciones de acceso abierto de Hipatia Press

Example:
    Ejecución básica::

        python scrapper_heritage_Historia_Social_Y_De_La_Educación.py

Note:
    URL: https://hipatiapress.com/hpjournals/index.php/hse/oai
"""
...
class Scraper:
    ...
    Example:
        ...
        ...     folders=["ALIA", "Revista_Historia_Social_Y_De_La_Educacion"],
        ...     urls="https://hipatiapress.com/hpjournals/index.php/hse/oai"
        ... )
        >>> scraper.execute()
    """
