"""Recolector de datos OAI-PMH para la Revista Anuario Calderoniano.

Este módulo recolecta artículos del Anuario Calderoniano publicado en
RECYT/FECYT mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Revista_Anuario_Calderoniano.py

Note:
    URL: https://recyt.fecyt.es/index.php/acal/oai
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Anuario_Calderoniano"],
        ...         "https://recyt.fecyt.es/index.php/acal/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Anuario_Calderoniano"],
        urls="https://recyt.fecyt.es/index.php/acal/oai"
    )
    scraper.execute()