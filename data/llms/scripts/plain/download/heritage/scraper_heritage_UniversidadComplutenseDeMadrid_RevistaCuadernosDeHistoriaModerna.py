"""Recolector de datos OAI-PMH para Cuadernos de Historia Moderna.

Este módulo recolecta artículos de Cuadernos de Historia Moderna (UCM) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadComplutenseDeMadrid_RevistaCuadernosDeHistoriaModerna.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Cuadernos_De_Historia_Moderna"],
        ...         "https://revistas.ucm.es/index.php/CHMO/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Cuadernos_De_Historia_Moderna"],
        urls="https://revistas.ucm.es/index.php/CHMO/oai"
    )
    scraper.execute()
