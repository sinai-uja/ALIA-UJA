"""Recolector de datos OAI-PMH para la Revista AusArt.

Este módulo recolecta artículos de la Revista AusArt (Universidad del País Vasco) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDelPaisVasco_RevistaAusArt.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_AusArt"],
        ...         "https://ojs.ehu.eus/index.php/ausart/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_AusArt"],
        urls="https://ojs.ehu.eus/index.php/ausart/oai"
    )
    scraper.execute()
