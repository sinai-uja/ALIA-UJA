"""Recolector de datos OAI-PMH para la Revista Cauriensia.

Este módulo implementa un método que recolecta información sobre artículos
de la Revista Cauriensia mediante el protocolo OAI-PMH utilizando el cliente
Sickle. Los metadatos se extraen de los registros OAI-DC y los documentos
(PDF, EPUB, DOCX) se descargan y se les extrae el texto para indexación.

La Revista Cauriensia contiene:
    - Artículos de teología, filosofía y ciencias humanas
    - Estudios interdisciplinares de la Diócesis de Cáceres
    - Publicaciones de acceso abierto

Example:
    Ejecución básica::

        python scrapper_heritage_Cauriensia.py
...
Note:
    Los datos son de acceso público a través del repositorio OAI-PMH.
    URL: https://cauriensia.es/index.php/cauriensia/oai
"""
...
class Scraper:
    ...
    Example:
        ...
        ...     folders=["ALIA", "Revista_Cauriensia"],
        ...     urls="https://cauriensia.es/index.php/cauriensia/oai"
        ... )
        >>> scraper.execute()
    """
    ...
    def __init__(self, config_path: str, folders: list[str], urls: str) -> None:
        ...
        Args:
            ...
            folders: Lista de carpetas anidadas para el dataset.
            urls: URL del endpoint OAI-PMH del repositorio.
...
if __name__ == "__main__":
    scraper = Scraper(
        config_path="config.yaml",
        folders=["ALIA", "Revista_Cauriensia"],
        urls="https://www.cauriensia.es/index.php/cauriensia/oai"
    )
    scraper.execute()