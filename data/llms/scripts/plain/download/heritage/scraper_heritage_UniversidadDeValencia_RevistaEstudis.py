"""Recolector de datos OAI-PMH para la Revista Estudis.

Este módulo recolecta artículos de la Revista Estudis (Universidad de Valencia) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDeValencia_RevistaEstudis.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Estudis"],
        ...         "https://turia.uv.es/index.php/estudis/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Estudis"],
        urls="https://turia.uv.es/index.php/estudis/oai"
    )
    scraper.execute()
