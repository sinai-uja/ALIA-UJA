"""Recolector de datos OAI-PMH para la Revista Aragón en la Edad Media.

Este módulo recolecta artículos de la Revista Aragón en la Edad Media (Universidad de Zaragoza)
mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scraper_heritage_UniZar_AragonEnLaEdadMedia.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_AragonEnLaEdadMedia"],
        ...         "https://papiro.unizar.es/ojs/index.php/aragon/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Aragon_En_La_Edad_Media"],
        urls="https://papiro.unizar.es/ojs/index.php/aem/oai"
    )
    scraper.execute()
