"""Recolector de datos OAI-PMH para la Revista Hipogrifo.

Este módulo recolecta artículos de la Revista Hipogrifo mediante OAI-PMH.

Example:
    python scrapper_heritage_Revista_Hipogrifo.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Hipogrifo"],
        ...         "https://www.revistahipogrifo.com/index.php/hipogrifo/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Hipogrifo"],
        urls="https://www.revistahipogrifo.com/index.php/hipogrifo/oai"
    )
    scraper.execute()