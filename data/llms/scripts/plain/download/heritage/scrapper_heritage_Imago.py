"""Recolector de datos OAI-PMH para la Revista IMAGO. Revista de Emblemática y Cultura Visual.

Este módulo recolecta artículos de la Revista IMAGO (Universitat de València)
mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Imago.py

Note:
    URL: https://turia.uv.es/index.php/IMAGO/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la Revista IMAGO.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Imago"],
        ...         "https://turia.uv.es/index.php/IMAGO/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Imago"],
        urls="https://turia.uv.es/index.php/IMAGO/oai"
    )
    scraper.execute()