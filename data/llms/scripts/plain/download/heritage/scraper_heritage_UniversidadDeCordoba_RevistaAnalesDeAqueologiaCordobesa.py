"""Recolector de datos OAI-PMH para Anales de Arqueología Cordobesa.

Este módulo recolecta artículos de Anales de Arqueología Cordobesa (UCO) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDeCordoba_RevistaAnalesDeAqueologiaCordobesa.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Anales_De_Arqueología_Cordobesa"],
        ...         "https://journals.uco.es/anarcor/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Anales_De_Arqueología_Cordobesa"],
        urls="https://journals.uco.es/anarcor/oai"
    )
    scraper.execute()
