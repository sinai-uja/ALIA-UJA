"""Recolector de datos OAI-PMH para Cuadernos de Historia Contemporánea.

Este módulo recolecta artículos de Cuadernos de Historia Contemporánea (UCM) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadComplutenseDeMadrid_RevistaCuadernosDeHistoriaContemporanea.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Cuadernos_De_Historia_Contemporanea"],
        ...         "https://revistas.ucm.es/index.php/CHCO/oai").execute()
    """
    ...
    def extract_text_from_pdf(self, pdf_path: str) -> str:
        try:
            ...
            # Extraer texto OCR de cada imagen y concatenar
            ocr_text = ""
            ...
            self.logger.error(f"Error extrayendo texto OCR del PDF {pdf_path}: {e}")
            return ""
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Cuadernos_De_Historia_Contemporanea"],
        urls="https://revistas.ucm.es/index.php/CHCO/oai"
    )
    scraper.execute()
