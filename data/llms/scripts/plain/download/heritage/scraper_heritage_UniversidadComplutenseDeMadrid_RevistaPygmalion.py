"""Recolector de datos OAI-PMH para la Revista Pygmalion.

Este módulo recolecta artículos de la Revista Pygmalion (UCM) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadComplutenseDeMadrid_RevistaPygmalion.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Pygmalion"],
        ...         "https://revistas.ucm.es/index.php/PYGM/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Pygmalion"],
        urls="https://revistas.ucm.es/index.php/PYGM/oai"
    )
    scraper.execute()
