"""Recolector de datos OAI-PMH para la Revista Rúbrica Contemporànea.

Este módulo recolecta artículos de la Revista Rúbrica Contemporànea (UAB)
mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Rubrica_Contemporanea.py

Note:
    URL: https://revistes.uab.cat/rubrica/oai
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Rubrica_Contemporanea"],
        ...         "https://revistes.uab.cat/rubrica/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Rubrica_Contemporanea"],
        urls="https://revistes.uab.cat/rubrica/oai"
    )
    scraper.execute()