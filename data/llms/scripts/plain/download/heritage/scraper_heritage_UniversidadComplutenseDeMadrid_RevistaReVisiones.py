"""Recolector de datos OAI-PMH para la Revista ReVisiones.

Este módulo recolecta artículos de la Revista ReVisiones (UCM) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadComplutenseDeMadrid_RevistaReVisiones.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_ReVisiones"],
        ...         "https://revistas.ucm.es/index.php/REVI/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_ReVisiones"],
        urls="https://revistas.ucm.es/index.php/REVI/oai"
    )
    scraper.execute()
