"""Recolector de datos OAI-PMH para la Revista Investigaciones Históricas. Época Moderna y Contemporánea.

Este módulo recolecta artículos de la Revista Investigaciones Históricas.
Época Moderna y Contemporánea (Universidad de Valladolid) mediante OAI-PMH.

Example:
    python scrapper_heritage_Investigaciones_Historicas_Epoca_Moderna_Y_Contemporanea.py

Note:
    URL: https://revistas.uva.es/index.php/invehisto/es/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la Revista Investigaciones Históricas.
    ...
    Example:
        >>> Scraper("config.yaml",
        ...         ["ALIA", "Revista_Investigaciones_Historicas_Epoca_Moderna_Y_Contemporanea"],
        ...         "https://revistas.uva.es/index.php/invehisto/es/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Investigaciones_Historicas_Epoca_Moderna_Y_Contemporanea"],
        urls="https://revistas.uva.es/index.php/invehisto/es/oai"
    )
    scraper.execute()