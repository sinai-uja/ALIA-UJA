"""Recolector de datos OAI-PMH para el Anuario Lope de Vega. Texto, Literatura, Cultura.

Este módulo recolecta artículos del Anuario Lope de Vega (UAB) mediante OAI-PMH.

Example:
    python scrapper_heritage_Revista_Anuario_Lope_De_Vega.py

Note:
    URL: https://revistes.uab.cat/anuariolopedevega/index.php/index/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para el Anuario Lope de Vega.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Anuario_Lope_De_Vega"],
        ...         "https://revistes.uab.cat/anuariolopedevega/index.php/index/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Anuario_Lope_De_Vega"],
        urls="https://revistes.uab.cat/anuariolopedevega/index.php/index/oai"
    )
    scraper.execute()