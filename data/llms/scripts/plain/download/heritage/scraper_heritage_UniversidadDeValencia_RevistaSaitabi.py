"""Recolector de datos OAI-PMH para la Revista Saitabi.

Este módulo recolecta artículos de la Revista Saitabi (Universidad de Valencia) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDeValencia_RevistaSaitabi.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Saitabi"],
        ...         "https://turia.uv.es/index.php/saitabi/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Saitabi"],
        urls="https://turia.uv.es/index.php/saitabi/oai"
    )
    scraper.execute()
