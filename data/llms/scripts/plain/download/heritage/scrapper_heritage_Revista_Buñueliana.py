"""Recolector de datos OAI-PMH para La Buñueliana. Revista de Estudios Cinematográficos.

Este módulo recolecta artículos de La Buñueliana (Universidad de Zaragoza)
mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Revista_Buñueliana.py

Note:
    URL: https://papiro.unizar.es/ojs/index.php/bunuel/es/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para La Buñueliana.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Buñueliana"],
        ...         "https://papiro.unizar.es/ojs/index.php/bunuel/es/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Buñueliana"],
        urls="https://papiro.unizar.es/ojs/index.php/bunuel/es/oai"
    )
    scraper.execute()