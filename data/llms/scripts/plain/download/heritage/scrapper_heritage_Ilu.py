"""Recolector de datos OAI-PMH para la Revista 'Ilu. Revista de Ciencias de las Religiones.

Este módulo recolecta artículos de la Revista 'Ilu (UCM) mediante OAI-PMH
utilizando el cliente Sickle, descargando y extrayendo texto de los documentos.

Example:
    python scrapper_heritage_Ilu.py

Note:
    URL: https://revistas.ucm.es/index.php/ILUR/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la Revista 'Ilu.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Ilu"],
        ...         "https://revistas.ucm.es/index.php/ILUR/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Ilu"],
        urls="https://revistas.ucm.es/index.php/ILUR/oai"
    )
    scraper.execute()