"""Recolector de datos OAI-PMH para la Revista Studia Aurea.

Este módulo recolecta artículos de la Revista Studia Aurea (UAB) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadAutonomaDeBarcelona_RevistaStudiaAurea.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_StudiaAurea"],
        ...         "https://revistes.uab.cat/studiaaurea/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Studia_Aurea"],
        urls="https://studiaaurea.com/index.php/index/oai"
    )
    scraper.execute()
