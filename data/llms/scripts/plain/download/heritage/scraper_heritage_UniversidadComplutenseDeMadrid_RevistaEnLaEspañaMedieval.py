"""Recolector de datos OAI-PMH para la Revista En la España Medieval.

Este módulo recolecta artículos de la Revista En la España Medieval (UCM) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadComplutenseDeMadrid_RevistaEnLaEspañaMedieval.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_En_La_España_Medieval"],
        ...         "https://revistas.ucm.es/index.php/ELEM/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_En_La_España_Medieval"],
        urls="https://revistas.ucm.es/index.php/ELEM/oai"
    )
    scraper.execute()
