"""Recolector de datos OAI-PMH para la Revista Crater.

Este módulo recolecta artículos de la Revista Crater (Universidad de Sevilla) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDeSevilla_RevistaCrater.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Crater"],
        ...         "https://revistascientificas.us.es/index.php/crater/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Crater"],
        urls="https://revistascientificas.us.es/index.php/crater/oai"
    )
    scraper.execute()
