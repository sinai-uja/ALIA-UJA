"""Recolector de datos OAI-PMH para la Revista Estudios Románicos.

Este módulo recolecta artículos de la Revista Estudios Románicos (Universidad de Murcia) mediante OAI-PMH.

Example:
    python scrapper_heritage_Revista_Estudios_Romanicos.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Estudios_Romanicos"],
        ...         "https://revistas.um.es/estudiosromanicos/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Estudios_Romanicos"],
        urls="https://revistas.um.es/estudiosromanicos/oai"
    )
    scraper.execute()