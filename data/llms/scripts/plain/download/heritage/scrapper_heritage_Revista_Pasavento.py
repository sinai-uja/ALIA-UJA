"""Recolector de datos OAI-PMH para la Revista Pasavento. Revista de Estudios Hispánicos.

Este módulo recolecta artículos de la Revista Pasavento (Universidad de Alcalá) mediante OAI-PMH.

Example:
    python scrapper_heritage_Revista_Pasavento.py

Note:
    URL: https://erevistas.publicaciones.uah.es/ojs/index.php/pasavento/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la Revista Pasavento.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Pasavento"],
        ...         "https://erevistas.publicaciones.uah.es/ojs/index.php/pasavento/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Pasavento"],
        urls="https://erevistas.publicaciones.uah.es/ojs/index.php/pasavento/oai"
    )
    scraper.execute()