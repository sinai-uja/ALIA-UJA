"""Recolector de datos OAI-PMH para la Revista Castilla. Estudios de Literatura.

Este módulo recolecta artículos de la Revista Castilla (Universidad de Valladolid)
mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Revista_Castilla.py

Note:
    URL: https://revistas.uva.es/index.php/castilla/es/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la Revista Castilla.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Castilla"],
        ...         "https://revistas.uva.es/index.php/castilla/es/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Castilla"],
        urls="https://revistas.uva.es/index.php/castilla/es/oai"
    )
    scraper.execute()