"""Recolector de datos OAI-PMH para la Revista Panta Rei.

Este módulo recolecta artículos de la Revista Panta Rei (Universidad de Murcia)
mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Panta_Rei.py

Note:
    URL: https://revistas.um.es/pantarei/oai
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Panta_Rei"],
        ...         "https://revistas.um.es/pantarei/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Panta_Rei"],
        urls="https://revistas.um.es/pantarei/oai"
    )
    scraper.execute()