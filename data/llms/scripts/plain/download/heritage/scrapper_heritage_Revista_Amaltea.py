"""Recolector de datos OAI-PMH para la Revista Amaltea. Revista de Mitocrítica.

Este módulo recolecta artículos de la Revista Amaltea (UCM) mediante
OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Revista_Amaltea.py

Note:
    URL: https://revistas.ucm.es/index.php/AMAL/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la Revista Amaltea.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Amaltea"],
        ...         "https://revistas.ucm.es/index.php/AMAL/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Amaltea"],
        urls="https://revistas.ucm.es/index.php/AMAL/oai"
    )
    scraper.execute()