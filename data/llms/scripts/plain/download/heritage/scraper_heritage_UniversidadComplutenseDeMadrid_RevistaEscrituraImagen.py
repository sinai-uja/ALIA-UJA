"""Recolector de datos OAI-PMH para la Revista Escritura e Imagen.

Este módulo recolecta artículos de la Revista Escritura e Imagen (UCM) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadComplutenseDeMadrid_RevistaEscrituraImagen.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Escritura_Imagen"],
        ...         "https://revistas.ucm.es/index.php/ESIM/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Escritura_Imagen"],
        urls="https://revistas.ucm.es/index.php/ESIM/oai"
    )
    scraper.execute()
