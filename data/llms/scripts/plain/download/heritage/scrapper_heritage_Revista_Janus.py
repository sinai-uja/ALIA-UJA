"""Recolector de datos OAI-PMH para la Revista Janus.

Este módulo recolecta artículos de la Revista Janus (Universidade da Coruña) mediante OAI-PMH.

Example:
    python scrapper_heritage_Revista_Janus.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Janus"],
        ...         "https://revistas.udc.es/index.php/janusdigital/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Janus"],
        urls="https://revistas.udc.es/index.php/janusdigital/oai"
    )
    scraper.execute()