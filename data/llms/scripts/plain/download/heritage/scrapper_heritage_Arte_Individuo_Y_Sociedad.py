"""Recolector de datos OAI-PMH para la Revista Arte, Individuo y Sociedad.

Este módulo implementa un método que recolecta información sobre artículos
de la Revista Arte, Individuo y Sociedad de la Universidad Complutense de
Madrid mediante el protocolo OAI-PMH utilizando el cliente Sickle. Los
metadatos se extraen de los registros OAI-DC y los documentos (PDF, EPUB,
DOCX) se descargan y se les extrae el texto para indexación.

La Revista Arte, Individuo y Sociedad contiene:
    - Artículos sobre artes visuales, educación artística y cultura visual
    - Investigaciones interdisciplinares sobre arte y sociedad
    - Publicaciones de acceso abierto de la UCM

Example:
    Ejecución básica::

        python scrapper_heritage_Arte_Individuo_Y_Sociedad.py
...
Note:
    ...
    URL: https://revistas.ucm.es/index.php/ARIS/oai
"""
...
class Scraper:
    ...
    el repositorio OAI-PMH de la UCM, incluyendo la descarga de documentos
    en formato PDF, EPUB y DOCX, la extracción de su texto y el almacenamiento
    de los metadatos en CSV y Parquet.
    ...
    Example:
        ...
        ...     folders=["ALIA", "Revista_Arte_Individuo_Y_Sociedad"],
        ...     urls="https://revistas.ucm.es/index.php/ARIS/oai"
        ... )
        >>> scraper.execute()
    """
    ...
    def __init__(self, config_path: str, folders: list[str], urls: str) -> None:
        ...
        Carga la configuración desde el archivo YAML, monta el disco de red,
        crea la estructura de carpetas del dataset y configura el logger.
        ...
        Args:
            ...
            folders: Lista de carpetas anidadas para crear la estructura
                del dataset (ej: ['ALIA', 'Revista_Arte_Individuo_Y_Sociedad']).
            urls: URL del endpoint OAI-PMH del repositorio.
