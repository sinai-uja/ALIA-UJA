"""Recolector de datos OAI-PMH para la Revista Signa.

Este módulo recolecta artículos de la Revista Signa (UNED) mediante OAI-PMH.

Example:
    python scrapper_heritage_Revista_Signa.py

Note:
    URL: https://revistas.uned.es/index.php/signa/oai
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Signa"],
        ...         "https://revistas.uned.es/index.php/signa/oai").execute()
    """
    ...
    async def process_registers(self) -> None:
        ...
        try:
            ...
            for record in records:
                ...
                base_name = metadata.get('title', []) or []
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Signa"],
        urls="https://revistas.uned.es/index.php/signa/oai"
    )
    scraper.execute()