"""Recolector de datos OAI-PMH para la Revista Saguntum.

Este módulo recolecta artículos de la Revista Saguntum (Universidad de Valencia) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDeValencia_RevistaSaguntum.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Saguntum"],
        ...         "https://turia.uv.es/index.php/saguntum/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Saguntum"],
        urls="https://turia.uv.es/index.php/saguntum/oai"
    )
    scraper.execute()
