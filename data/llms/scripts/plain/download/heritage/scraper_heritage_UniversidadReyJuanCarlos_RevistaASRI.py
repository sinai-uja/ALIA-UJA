"""Recolector de datos OAI-PMH para la Revista ASRI.

Este módulo recolecta artículos de la Revista ASRI (Universidad Rey Juan Carlos) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadReyJuanCarlos_RevistaASRI.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_ASRI"],
        ...         "https://revistaasri.com/index/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_ASRI"],
        urls="https://revistaasri.com/index/oai"
    )
    scraper.execute()
