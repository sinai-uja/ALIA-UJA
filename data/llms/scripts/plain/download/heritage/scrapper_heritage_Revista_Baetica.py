"""Recolector de datos OAI-PMH para la Revista Baetica. Estudios de Arte, Geografía e Historia.

Este módulo recolecta artículos de la Revista Baetica (Universidad de Málaga)
mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Revista_Baetica.py

Note:
    URL: https://www.revistas.uma.es/index.php/baetica/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la Revista Baetica.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Baetica"],
        ...         "https://www.revistas.uma.es/index.php/baetica/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Baetica"],
        urls="https://www.revistas.uma.es/index.php/baetica/oai"
    )
    scraper.execute()