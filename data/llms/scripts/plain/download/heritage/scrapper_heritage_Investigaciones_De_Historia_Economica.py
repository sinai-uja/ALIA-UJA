"""Recolector de datos OAI-PMH para la Revista Investigaciones de Historia Económica.

Este módulo recolecta artículos de la Revista Investigaciones de Historia
Económica (FECYT/AEHE) mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Investigaciones_De_Historia_Economica.py

Note:
    URL: https://recyt.fecyt.es/index.php/IHE/oai
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml",
        ...         ["ALIA", "Revista_Investigaciones_De_Historia_Economica"],
        ...         "https://recyt.fecyt.es/index.php/IHE/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Investigaciones_De_Historia_Economica"],
        urls="https://recyt.fecyt.es/index.php/IHE/oai"
    )
    scraper.execute()