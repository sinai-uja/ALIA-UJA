"""Recolector de datos OAI-PMH para la Revista de Medio Aevo.

Este módulo recolecta artículos de la Revista de Medio Aevo (UCM) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadComplutenseDeMadrid_RevistaDeMedioAevo.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_De_Medio_Aevo"],
        ...         "https://revistas.ucm.es/index.php/DMAE/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_De_Medio_Aevo"],
        urls="https://revistas.ucm.es/index.php/DMAE/oai"
    )
    scraper.execute()
