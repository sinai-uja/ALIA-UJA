"""Recolector de datos OAI-PMH para el Boletín de Literatura Oral.

Este módulo recolecta artículos del Boletín de Literatura Oral (Universidad de Jaén) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDeJaen_RevistaBoletinDeLiteraturaOral.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Patrimonio_Boletin_De_Literatura_Oral"],
        ...         "https://revistaselectronicas.ujaen.es/index.php/blo/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Patrimonio_Boletin_De_Literatura_Oral"],
        urls="https://revistaselectronicas.ujaen.es/index.php/blo/oai"
    )
    scraper.execute()
