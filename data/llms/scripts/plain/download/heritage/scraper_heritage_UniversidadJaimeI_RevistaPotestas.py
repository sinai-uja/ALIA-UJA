"""Recolector de datos OAI-PMH para la Revista Potestas.

Este módulo recolecta artículos de la Revista Potestas (Universitat Jaume I) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadJaimeI_RevistaPotestas.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Potestas"],
        ...         "https://www.e-revistes.uji.es/index.php/potestas/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Potestas"],
        urls="https://www.e-revistes.uji.es/index.php/potestas/oai"
    )
    scraper.execute()
