"""Recolector de datos OAI-PMH para la Revista Cuadernos de Ilustración y Romanticismo.

Este módulo implementa un método que recolecta información sobre artículos
de la Revista Cuadernos de Ilustración y Romanticismo de la Universidad de
Cádiz mediante el protocolo OAI-PMH utilizando el cliente Sickle.

La Revista Cuadernos de Ilustración y Romanticismo contiene:
    - Artículos sobre literatura y cultura del siglo XVIII y XIX
    - Estudios sobre la Ilustración y el Romanticismo español
    - Publicaciones de acceso abierto de la UCA

Example:
    Ejecución básica::

        python scrapper_heritage_Cuadernos_De_Ilustracion_Y_Romanticismo.py

Note:
    URL: https://revistas.uca.es/index.php/cir/oai
"""
...
class Scraper:
    ...
    Example:
        ...
        ...     folders=["ALIA", "Revista_Cuadernos_De_Ilustracion_Y_Romanticismo"],
        ...     urls="https://revistas.uca.es/index.php/cir/oai"
        ... )
        >>> scraper.execute()
    """
