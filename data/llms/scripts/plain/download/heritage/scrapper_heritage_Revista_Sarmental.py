"""Recolector de datos OAI-PMH para la Revista Sarmental. Estudios de Historia del Arte y la Arquitectura.

Este módulo recolecta artículos de la Revista Sarmental (Universidad de Burgos)
mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Revista_Sarmental.py

Note:
    URL: https://revistas.ubu.es/sarmental/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la Revista Sarmental.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Sarmental"],
        ...         "https://revistas.ubu.es/sarmental/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Sarmental"],
        urls="https://revistas.ubu.es/sarmental/oai"
    )
    scraper.execute()