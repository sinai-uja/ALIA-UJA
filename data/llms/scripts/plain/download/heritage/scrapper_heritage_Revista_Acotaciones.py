"""Recolector de datos OAI-PMH para la Revista Acotaciones.

Este módulo recolecta artículos de la Revista Acotaciones (RESAD) mediante
OAI-PMH utilizando el cliente Sickle.

Example:
    python scrapper_heritage_Revista_Acotaciones.py

Note:
    URL: https://www.resad.com/Acotaciones.new/index.php/ACT/oai
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Acotaciones"],
        ...         "https://www.resad.com/Acotaciones.new/index.php/ACT/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Acotaciones"],
        urls="https://www.resad.com/Acotaciones.new/index.php/ACT/oai"
    )
    scraper.execute()