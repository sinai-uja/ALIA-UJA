"""Recolector de datos OAI-PMH para la Revista Liño.

Este módulo recolecta artículos de la Revista Liño (Universidad de Oviedo) mediante OAI-PMH.

Example:
    python scraper_heritage_UniversidadDeOviedo_Liño.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Liño"],
        ...         "https://reunido.uniovi.es/index.php/RAHA/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Liño"],
        urls="https://reunido.uniovi.es/index.php/RAHA/oai"
    )
    scraper.execute()
