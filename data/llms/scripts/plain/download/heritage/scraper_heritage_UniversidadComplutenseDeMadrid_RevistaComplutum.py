"""Recolector de datos OAI-PMH para la Revista Complutum.

Este módulo recolecta artículos de la Revista Complutum (Universidad Complutense de Madrid)
mediante OAI-PMH utilizando el cliente Sickle.

Example:
    python scraper_heritage_UniversidadComplutenseDeMadrid_RevistaComplutum.py
"""
...
class Scraper:
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Complutum"],
        ...         "https://revistas.ucm.es/index.php/CMPL/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Complutum"],
        urls="https://revistas.ucm.es/index.php/CMPL/oai"
    )
    scraper.execute()
