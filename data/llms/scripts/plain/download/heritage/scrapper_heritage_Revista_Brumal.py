"""Recolector de datos OAI-PMH para la Revista Brumal. Revista de Investigación sobre lo Fantástico.

Este módulo recolecta artículos de la Revista Brumal (UAB) mediante OAI-PMH.

Example:
    python scrapper_heritage_Revista_Brumal.py

Note:
    URL: https://revistes.uab.cat/brumal/index/oai
"""
...
class Scraper:
    """Recolector de datos OAI-PMH para la Revista Brumal.
    ...
    Example:
        >>> Scraper("config.yaml", ["ALIA", "Revista_Brumal"],
        ...         "https://revistes.uab.cat/brumal/index/oai").execute()
    """
...
if __name__ == "__main__":
    scraper = Scraper(
        ...
        folders=["ALIA", "Revista_Brumal"],
        urls="https://revistes.uab.cat/brumal/index/oai"
    )
    scraper.execute()