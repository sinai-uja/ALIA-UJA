# ALIA | Grupo SINAI 
***Directorio de Datos | Modelos de Lenguaje | Scripts de Descarga***
...
- Documentación de Datasets
  - [Documentación del Flujo de Trabajo para Construir y Documentar un Dataset](/documentation/data/llms/plain/workflow.md)
    - [Proceso de Descarga](/documentation/data/llms/plain/process_download.md)

## Índice de ficheros en el directorio
- Ficheros de código
  - [Descarga de datos del dominio biomédico](/data/llms/scripts/plain/download/biomedical)
  - [Descarga de datos del dominio de patrimonio histórico/cultural](/data/llms/scripts/plain/download/heritage)
  - [Descarga de datos del dominio legal-administrativo](/data/llms/scripts/plain/download/legal)
