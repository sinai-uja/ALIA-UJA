...
def setup_headers(config: Dict[str, Any]) -> Dict[str, List[str]]:
    ...
    return {
        ...
        "selections": [id_col, "id_document", "passage", "character", "selected_character", "question_type", "difficulty", "selection_model", "source_id"],
        "queries": [id_col, "id_document", "passage", "character", "type", "difficulty", "query", "answer", "query_model", "source_id"]
    }
        ...
        while attempts < api_max_attempts:
            try:
                ...
                break # Skip batch or let it continue depending on criticality. 
                      # User asked specifically for API failure logic.
