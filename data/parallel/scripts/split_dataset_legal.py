...
# Configure logging
log_path = 'logs/split_del_dataset_de_legal.log'
...
input_path = 'data/parallel/data/raw/legal/'
output_path = 'data/proccessed/legal/'
dataset_identifiers = {
    'EURLEX': '01',
    'EUROPAT': '02',
    'UNPC': '03'
...
if not processed_dfs:
    ...
    if total_size < (val_size + test_size):
        ...
        print("Dataset split and saved successfully using polars. Check the log file for details: logs/split_del_dataset_de_legal.log")