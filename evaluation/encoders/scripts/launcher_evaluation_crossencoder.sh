...
echo "Ejecutando evaluación estática con args: evaluation_static_metrics_crossencoder.py $*"
SCRIPTS_DIR="/path_to/evaluation/encoder/scripts"
srun python "$SCRIPTS_DIR/evaluation_static_metrics_crossencoder.py" "$@"